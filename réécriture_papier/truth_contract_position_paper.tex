...
% The same reference and marking requirement; only permission differs.
\node[fone contract] (contract-factual) at (0,-4.45) {
  \textbf{Extracted truth contract}\\[7pt]
  \textbf{Reference evidence:} source excerpt (right)\\[3pt]
  \textbf{Permission scope:} no reconstruction beyond the reference\\[3pt]
  \textbf{Required status marking:} uncertainty stated clearly
};
\node[fone contract] (contract-creative) at (8.10,-4.45) {
  \textbf{Extracted truth contract}\\[7pt]
  \textbf{Reference evidence:} source excerpt (right)\\[3pt]
  \textbf{Permission scope:} one plausible reconstruction\\[3pt]
  \textbf{Required status marking:} uncertainty stated clearly
};
...
\node[anchor=north west,align=left,text width=4.05cm,inner sep=8pt]
  ...
  Wikipedia article ``Rosetta Stone''\\[7pt]
  ...
  \emph{Illustrative input; this excerpt alone defines the reference.}
};
...
\node[fone evaluation] (eval-factual) at (0,-12.65) {
  \textbf{Evaluation: factual task}\\[7pt]
  \textbf{Claim checked:} the complete stele stood near a temple entrance.
  The excerpt does not confirm or reject it.\\[8pt]
  {\color{fOneRed}\bfseries HALLUCINATION (H)}\\[4pt]
  The reference is silent, and this task allows no reconstruction.
};
\node[fone evaluation] (eval-creative) at (7.70,-12.65) {
  \textbf{Evaluation: creative task}\\[7pt]
  \textbf{Claim checked:} the complete stele stood near a temple entrance.
  The excerpt does not confirm or reject it.\\[8pt]
  {\color{fOneGreen}\bfseries LICENSED DIVERGENCE (LD)}\\[4pt]
  The reference is silent, but one marked reconstruction is allowed.
};
...
\node[anchor=north,align=center,text width=13.65cm,inner sep=3pt]
  ...
  \textbf{Only what the task permits changes inside the truth contract;}\\
  \textbf{requested writing style is evaluated separately.}\\[4pt]
...
and required status marking. Only the permission differs. The
...
For this constructed evaluation, the displayed excerpt alone defines the
reference; no additional Wikipedia content is used. The excerpt is an
illustrative input, not a documented verbatim quotation of a versioned article.}
...
\centering
\IfFileExists{figures/AA-Omniscience Hallucination Rate vs- Total Parameters (26 Aug '26) (1).png}{\includegraphics[width=0.98\linewidth]{figures/AA-Omniscience Hallucination Rate vs- Total Parameters (26 Aug '26) (1).png}}{\fbox{\parbox{0.90\linewidth}{\textbf{Source graphic not supplied.} Restore the original AA-Omniscience snapshot image from the source project. No measurements are reconstructed here.}}}
\par\smallskip
\IfFileExists{figures/AA-Omniscience Index - Score vs- Release Date (26 Aug '26).png}{\includegraphics[width=0.98\linewidth]{figures/AA-Omniscience Index - Score vs- Release Date (26 Aug '26).png}}{\fbox{\parbox{0.90\linewidth}{\textbf{Source graphic not supplied.} Restore the original AA-Omniscience snapshot image from the source project. No measurements are reconstructed here.}}}

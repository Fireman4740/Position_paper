...
An entailed claim receives \emph{supported} (\SUP) label.
A contradicted or unlicensed claim is labeled as \emph{hallucination} (\Hall), whereas an evidence-unknown but licensed claim receives \emph{licensed divergence} (\LD) label.
